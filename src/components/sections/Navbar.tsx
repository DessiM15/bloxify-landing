    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <a
            href="https://www.facebook.com/share/1E2u9jExgV/?mibextid=wwXIfr"
            target="_blank"
            rel="noopener noreferrer"
            className="text-cream-dim hover:text-coral transition-colors"
            aria-label="Facebook"
          ...
          <a
            href="https://discord.gg/wJM2JcgC"
            target="_blank"
            rel="noopener noreferrer"
            className="text-cream-dim hover:text-coral transition-colors"
            aria-label="Discord"
        ...
        <div className="flex md:hidden items-center gap-3">
          {launched ? (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-full bg-coral px-5 py-2.5 text-sm font-bold text-navy transition-colors hover:bg-coral-dark"
            >
              Download
            </a>
          ) : (
          ...
          <button
            ...
            className="text-cream-dim hover:text-coral transition-colors p-1"
      ...
      >
        <div className="glass-strong mx-4 mt-3 rounded-2xl px-6 py-5 flex flex-col gap-4">
