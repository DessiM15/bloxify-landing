...
function CountdownImagePreview() {
  ...
  const inlineSrc = `/api/countdown-image?format=${format}&inline=true&t=${tick}`;
  const downloadHref = `/api/countdown-image?format=${format}`;

  return (
    <div className="flex flex-col items-center gap-3 mt-4">
      <p className="text-cream-dim text-xs font-medium uppercase tracking-widest">
        Shareable Image
      </p>
      ...
      >
        ...
        Download {format === "story" ? "Story" : "Square"} Image
      </a>
    </div>
  );
}
...
export default function Countdown() {
  ...
  return (
    ...
    >
      ...
      {!launched && (
        <div className="hidden lg:block absolute left-0 xl:left-8 top-[140px] w-[448px] h-[448px] pointer-events-none z-0">
          <Image
